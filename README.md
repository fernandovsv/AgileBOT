...
AgileBOT is a chat bot built on the [Hubot][hubot] framework. It was
...
Then you can interact with AgileBOT by typing `AgileBOT help`.

    AgileBOT> AgileBOT help
